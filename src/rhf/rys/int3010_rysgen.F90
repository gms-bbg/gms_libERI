...
submodule(rys_kernels) int3010_impl
contains
  module subroutine int3010(sf_pair, sp_pair, density, fock, res)
    ...
    integer(kind=int64), allocatable :: n03bra(:), n01ket(:)
    real(dp), allocatable :: xint03bra(:), xint01ket(:)
    integer(kind=int64) :: nsfbra, nspket
    real(dp) :: scutsfbra, scutspket, test
    ...
    real(dp) :: d03bra(10), d01ket(3)
    integer(kind=int64) :: ix(10), jx(1), kx(3), lx(1)
    integer(kind=int64) :: iy(10), jy(1), ky(3), ly(1)
    integer(kind=int64) :: iz(10), jz(1), kz(3), lz(1)
    integer(kind=int64) :: in(4), in1(4), kn(2)
    ...
    if ((nsfbra*nspket) .le. nchunksize_int64) nchunksize_int64 = nsfbra*nspket
    ntile = int(nsfbra*nspket/nchunksize_int64)
    do itile = 1, ntile
      istart = (itile - 1)*nchunksize_int64 + 1
      iend = itile*nchunksize_int64
      if (itile .eq. ntile) iend = nsfbra*nspket
 ...
 !$omp shared(res, density, fock, nquart_start, nquart_end, nsfbra, xint03bra, n03bra, xint01ket, n01ket, sf_pair, sp_pair) &
 ...
 !$omp private(jk,jl)
            do iquart = nquart_start, nquart_end
              ...
              test = xint03bra(ij_tmp)*xint01ket(kl_tmp)
...
310                                   continue
                                      ...
                                      xin(4) = xcp00*xin(3) + cp10
                                      yin(4) = ycp00*yin(3) + cp10
                                      zin(4) = zcp00*zin(3) + cp10*f00
                                      ...
                                      xin(6) = xcp00*xin(5) + cp10*xin(3)
                                      yin(6) = ycp00*yin(5) + cp10*yin(3)
                                      zin(6) = zcp00*zin(5) + cp10*zin(3)
                                      ...
                                      xin(8) = xcp00*xin(7) + cp10*xin(5)
                                      yin(8) = ycp00*yin(7) + cp10*yin(5)
                                      zin(8) = zcp00*zin(7) + cp10*zin(5)
                                      ...
                                      xin(12) = xcp00*xin(11) + cp10
                                      yin(12) = ycp00*yin(11) + cp10
                                      zin(12) = zcp00*zin(11) + cp10*f00
                                      ...
                                      xin(14) = xcp00*xin(13) + cp10*xin(11)
                                      yin(14) = ycp00*yin(13) + cp10*yin(11)
                                      zin(14) = zcp00*zin(13) + cp10*zin(11)
                                      ...
                                      xin(20) = xcp00*xin(19) + cp10
                                      yin(20) = ycp00*yin(19) + cp10
                                      zin(20) = zcp00*zin(19) + cp10*f00
          ...
          eri_value(1) = eri_value(1) + d03bra(1)*d01ket(1)*(xin(8)*yin(1)*zin(1) + xin(16)*yin(9)*zin(9) + xin(24)*yin(17)*zin(17))
         eri_value(2) = eri_value(2) + d03bra(1)*d01ket(2)*(xin(7)*yin(2)*zin(1) + xin(15)*yin(10)*zin(9) + xin(23)*yin(18)*zin(17))
         eri_value(3) = eri_value(3) + d03bra(1)*d01ket(3)*(xin(7)*yin(1)*zin(2) + xin(15)*yin(9)*zin(10) + xin(23)*yin(17)*zin(18))
         eri_value(4) = eri_value(4) + d03bra(2)*d01ket(1)*(xin(2)*yin(7)*zin(1) + xin(10)*yin(15)*zin(9) + xin(18)*yin(23)*zin(17))
          eri_value(5) = eri_value(5) + d03bra(2)*d01ket(2)*(xin(1)*yin(8)*zin(1) + xin(9)*yin(16)*zin(9) + xin(17)*yin(24)*zin(17))
         eri_value(6) = eri_value(6) + d03bra(2)*d01ket(3)*(xin(1)*yin(7)*zin(2) + xin(9)*yin(15)*zin(10) + xin(17)*yin(23)*zin(18))
         eri_value(7) = eri_value(7) + d03bra(3)*d01ket(1)*(xin(2)*yin(1)*zin(7) + xin(10)*yin(9)*zin(15) + xin(18)*yin(17)*zin(23))
         eri_value(8) = eri_value(8) + d03bra(3)*d01ket(2)*(xin(1)*yin(2)*zin(7) + xin(9)*yin(10)*zin(15) + xin(17)*yin(18)*zin(23))
          eri_value(9) = eri_value(9) + d03bra(3)*d01ket(3)*(xin(1)*yin(1)*zin(8) + xin(9)*yin(9)*zin(16) + xin(17)*yin(17)*zin(24))
       eri_value(10) = eri_value(10) + d03bra(4)*d01ket(1)*(xin(6)*yin(3)*zin(1) + xin(14)*yin(11)*zin(9) + xin(22)*yin(19)*zin(17))
       eri_value(11) = eri_value(11) + d03bra(4)*d01ket(2)*(xin(5)*yin(4)*zin(1) + xin(13)*yin(12)*zin(9) + xin(21)*yin(20)*zin(17))
      eri_value(12) = eri_value(12) + d03bra(4)*d01ket(3)*(xin(5)*yin(3)*zin(2) + xin(13)*yin(11)*zin(10) + xin(21)*yin(19)*zin(18))
       eri_value(13) = eri_value(13) + d03bra(5)*d01ket(1)*(xin(6)*yin(1)*zin(3) + xin(14)*yin(9)*zin(11) + xin(22)*yin(17)*zin(19))
      eri_value(14) = eri_value(14) + d03bra(5)*d01ket(2)*(xin(5)*yin(2)*zin(3) + xin(13)*yin(10)*zin(11) + xin(21)*yin(18)*zin(19))
       eri_value(15) = eri_value(15) + d03bra(5)*d01ket(3)*(xin(5)*yin(1)*zin(4) + xin(13)*yin(9)*zin(12) + xin(21)*yin(17)*zin(20))
       eri_value(16) = eri_value(16) + d03bra(6)*d01ket(1)*(xin(4)*yin(5)*zin(1) + xin(12)*yin(13)*zin(9) + xin(20)*yin(21)*zin(17))
       eri_value(17) = eri_value(17) + d03bra(6)*d01ket(2)*(xin(3)*yin(6)*zin(1) + xin(11)*yin(14)*zin(9) + xin(19)*yin(22)*zin(17))
      eri_value(18) = eri_value(18) + d03bra(6)*d01ket(3)*(xin(3)*yin(5)*zin(2) + xin(11)*yin(13)*zin(10) + xin(19)*yin(21)*zin(18))
      eri_value(19) = eri_value(19) + d03bra(7)*d01ket(1)*(xin(2)*yin(5)*zin(3) + xin(10)*yin(13)*zin(11) + xin(18)*yin(21)*zin(19))
       eri_value(20) = eri_value(20) + d03bra(7)*d01ket(2)*(xin(1)*yin(6)*zin(3) + xin(9)*yin(14)*zin(11) + xin(17)*yin(22)*zin(19))
       eri_value(21) = eri_value(21) + d03bra(7)*d01ket(3)*(xin(1)*yin(5)*zin(4) + xin(9)*yin(13)*zin(12) + xin(17)*yin(21)*zin(20))
       eri_value(22) = eri_value(22) + d03bra(8)*d01ket(1)*(xin(4)*yin(1)*zin(5) + xin(12)*yin(9)*zin(13) + xin(20)*yin(17)*zin(21))
      eri_value(23) = eri_value(23) + d03bra(8)*d01ket(2)*(xin(3)*yin(2)*zin(5) + xin(11)*yin(10)*zin(13) + xin(19)*yin(18)*zin(21))
       eri_value(24) = eri_value(24) + d03bra(8)*d01ket(3)*(xin(3)*yin(1)*zin(6) + xin(11)*yin(9)*zin(14) + xin(19)*yin(17)*zin(22))
      eri_value(25) = eri_value(25) + d03bra(9)*d01ket(1)*(xin(2)*yin(3)*zin(5) + xin(10)*yin(11)*zin(13) + xin(18)*yin(19)*zin(21))
       eri_value(26) = eri_value(26) + d03bra(9)*d01ket(2)*(xin(1)*yin(4)*zin(5) + xin(9)*yin(12)*zin(13) + xin(17)*yin(20)*zin(21))
       eri_value(27) = eri_value(27) + d03bra(9)*d01ket(3)*(xin(1)*yin(3)*zin(6) + xin(9)*yin(11)*zin(14) + xin(17)*yin(19)*zin(22))
     eri_value(28) = eri_value(28) + d03bra(10)*d01ket(1)*(xin(4)*yin(3)*zin(3) + xin(12)*yin(11)*zin(11) + xin(20)*yin(19)*zin(19))
     eri_value(29) = eri_value(29) + d03bra(10)*d01ket(2)*(xin(3)*yin(4)*zin(3) + xin(11)*yin(12)*zin(11) + xin(19)*yin(20)*zin(19))
     eri_value(30) = eri_value(30) + d03bra(10)*d01ket(3)*(xin(3)*yin(3)*zin(4) + xin(11)*yin(11)*zin(12) + xin(19)*yin(19)*zin(20))
